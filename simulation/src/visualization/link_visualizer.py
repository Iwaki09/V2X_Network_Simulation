...
def run_visualization(fcd_file: str = None, csv_file: str = None, output_dir: str = None):
    ...
    if fcd_file is None:
        fcd_file = str(script_dir / 'output/fcd/fcd_output.xml')
    if csv_file is None:
        csv_file = str(script_dir / 'output/raytracing/link_quality_results.csv')
    if output_dir is None:
        output_dir = str(script_dir / 'output/visualizations/frames')
