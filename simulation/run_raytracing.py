...
from fcd_parser import parse_fcd_xml, print_summary, get_vehicle_positions
from raytracing_simulation import (
    RayTracingSimulator,
    BaseStation,
    Building,
    LinkQuality
...
def save_link_quality_csv(link_qualities: List[LinkQuality], output_path: str):
    """
    リンク品質結果をCSVファイルに保存
...
def main():
    ...
    output_csv = "output/raytracing/link_quality_results.csv"
    ...
    try:
        save_link_quality_csv(all_link_qualities, output_csv)
